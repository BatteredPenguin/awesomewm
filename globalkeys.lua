...
local keys = gears.table.join(
    ...
    awful.key({ altkey }, "XF86AudioRaiseVolume",
      function ()
        os.execute(string.format("amixer -q set %s 90%%", "Master"))
        --beautiful.volume.update()
      end),
    -- Low Volume
    awful.key({ altkey }, "XF86AudioLowerVolume",
      function ()
        os.execute(string.format("amixer -q set %s 12%%", "Master"))
        --beautiful.volume.update()
      end),
    -- Brightness
    awful.key({}, "XF86MonBrightnessUp", function ()
        os.execute("sudo xbright +150")
      end),
    awful.key({}, "XF86MonBrightnessDown", function ()
        os.execute("sudo xbright -150")
      end),
    awful.key({ altkey }, "XF86MonBrightnessUp", function ()
        os.execute("sudo xbright =1250")
      end),
    awful.key({ altkey }, "XF86MonBrightnessDown", function ()
        os.execute("sudo xbright =250")
      end),
    -- Lock screen
