...
local GET_VOLUME_CMD = string.format('amixer -D pulse sget %s', VOLUME_CHANNEL)
local INC_VOLUME_CMD = string.format('amixer -D pulse sset 5%%+', VOLUME_CHANNEL)
local DEC_VOLUME_CMD = string.format('amixer -D pulse sset 5%%-', VOLUME_CHANNEL)
local TOG_VOLUME_CMD = string.format('amixer -D pulse sset %s toggle', VOLUME_CHANNEL)
...
local function worker(args)
    ...
    local height = args.height or 22
